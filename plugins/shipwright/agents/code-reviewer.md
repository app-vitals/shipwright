...
These apply in addition to generic review. Rules 6, 7, and 8 cite domain entries from the
project's principles source: check for a project-level override at
`.claude/shipwright/principles.md` in the repo root first; if it doesn't exist, fall back to
`references/principles.md` (relative to the plugin root).
