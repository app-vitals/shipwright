...
| `agent.voice.whisper.image` | `onerahmet/openai-whisper-asr-webservice:v1.10.0` | Whisper ASR image (exposes `POST /asr`). Already pinned to a tested tag — do not float to `:latest`. |
