...
There are three natural paths through these docs: **evaluate** whether Shipwright fits your pipeline by
reading how it works below, **adopt** it by installing the plugin into your Claude Code workspace and
connecting it to your repository, and **operate** it by deploying it as a cloud agent that runs
autonomously on a schedule. Read on for the full picture, or jump straight to [Getting
Started](/docs/getting-started) or [Day-to-Day Operations](/docs/day-to-day-operations).
