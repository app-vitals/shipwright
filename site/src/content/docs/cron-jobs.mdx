...
| `shipwright-site-docs-freshness` | daily 07:00 | `/docs-sync --auto` | — | off | Flags marketing-site pages that have drifted from their mapped source docs and files a proposal task instead of auto-editing. |
