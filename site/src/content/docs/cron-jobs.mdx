...
`learn-dream`, `dependency-bot-triage`, and the entropy/error/security/consolidation patrol crons —
...
| `dependency-bot-triage` | daily 08:00 | `/shipwright:triage-dependency-bot-prs` | triage-dependency-bot-prs | off | Reviews and triages open Dependabot/Renovate PRs, posting triage comments directly by default (opt out via `auto_post_dependency_bot_triage: false`). |
