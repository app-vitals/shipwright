...
CREATE TABLE "AgentEnv" (
    ...
    CONSTRAINT "AgentEnv_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "AgentPlugin" (
    ...
    CONSTRAINT "AgentPlugin_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "AgentEnv" ADD CONSTRAINT "AgentEnv_agentId_fkey" FOREIGN KEY ("agentId") REFERENCES "Agent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AgentPlugin" ADD CONSTRAINT "AgentPlugin_agentId_fkey" FOREIGN KEY ("agentId") REFERENCES "Agent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
