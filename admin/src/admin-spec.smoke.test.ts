...
function buildSpecApp() {
  const runtimeApp = createAgentRuntimeApp({
    agentEnvService: { async getConfigBundle() { return null; } },
    agentCronJobService: { async list() { return []; } },
    prisma: {
  ...
  const adminApp = createAdminApp({
    ...
    agentCronJobService: {
      list: async () => [],
      create: async () => ({
        id: "c1", agentId: "a1", schedule: "", prompt: "",
        channel: null, user: null, silent: false, enabled: true, preCheck: null,
        name: null, system: false, createdAt: new Date(), updatedAt: new Date(),
      }),
      update: async () => ({
        id: "c1", agentId: "a1", schedule: "", prompt: "",
        channel: null, user: null, silent: false, enabled: true, preCheck: null,
      ...
      setEnabled: async (_a, _c, enabled) => ({
        id: "c1", agentId: "a1", schedule: "", prompt: "",
        channel: null, user: null, silent: false, enabled, preCheck: null,
        name: null, system: false, createdAt: new Date(), updatedAt: new Date(),
      }),
      updatePreCheck: async (_a, _c, preCheck) => ({
        id: "c1", agentId: "a1", schedule: "", prompt: "",
        channel: null, user: null, silent: false, enabled: true, preCheck,
        name: null, system: false, createdAt: new Date(), updatedAt: new Date(),
      }),
    ...
    agentToolService: {
      list: async () => [],
      add: async () => ({ id: "t1", agentId: "a1", pattern: "Read", enabled: true, createdAt: new Date() }),
      remove: async () => {},
      toggle: async () => ({ id: "t1", agentId: "a1", pattern: "Read", enabled: false, createdAt: new Date() }),
    },
    agentTokenService: {
      create: async () => ({
        token: { id: "tok1", agentId: "a1", token: "hash", label: null, createdAt: new Date(), revokedAt: null },
        rawToken: "raw",
      }),
      listForAgent: async () => [],
      revoke: async () => ({ id: "tok1", agentId: "a1", token: "hash", label: null, createdAt: new Date(), revokedAt: new Date() }),
      validate: async () => null,
    },
    agentPluginService: {
      list: async () => [],
      add: async () => ({ id: "p1", agentId: "a1", name: "plugin", version: null, enabled: true, createdAt: new Date(), updatedAt: new Date() }),
      remove: async () => {},
      removeByName: async () => {},
    },
    prisma: {
      agent: {
        create: async () => ({ id: "new-id", name: "New", slackId: null, createdAt: new Date(), updatedAt: new Date() }),
        findUnique: async () => null,
        findMany: async () => [],
        delete: async () => ({ id: "id", name: "Name", slackId: null, createdAt: new Date(), updatedAt: new Date() }),
      },
    } as never,
