...
const MOCK_CRON = {
  ...
  system: false,
  parentCronId: null as string | null,
...
// patchAuthorAllowlist is independent of reviewAuthorAllowlist. Every case
// below sends a *valid* reviewAuthorAllowlist alongside it, so a 400 can
